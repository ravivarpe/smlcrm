       ...
       <div class="row">
          ...
          <div class="col-sm-12">
             <div class="card lobicard all_btn_card" id="lobicard-custom-control1" data-sortable="true">
                 ...
                 <div class="card-body">
                <form action="{{route('material.add')}}" method="post" enctype="multipart/form-data">
                    @csrf
                   <div class="col-sm-12">
                      <div class="row">
                    ...
                    <div class="form-group row mx-0">
                        ...
                        <div class="col-sm-12 px-0">
                           <label class="checkbox-inline">
                               <input type="checkbox" id="inlineCheckbox1" value="1" name="purchase_vat"> Yes
                             </label>

                             <label class="checkbox-inline">
                               <input type="checkbox" id="inlineCheckbox2" value="1" name="purchase_vat"> No
                             </label></div>
                     </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Individual" name="indivisuals">
                     </div>
                      ...
                      <div class="form-check">
                         ...
                         <input type="radio" name="material_status" value="1" checked="checked"> Active</label>
                         <label class="radio-inline"><input type="radio" name="material_status" value="0" >Inactive</label>
