       ...
       <div class="row">
          ...
          <div class="col-sm-12">
             <div class="card lobicard all_btn_card" id="lobicard-custom-control1" data-sortable="true">
                 ...
                 <div class="card-body">
                <form action="{{route('snagging.add')}}" method="post" enctype="multipart/form-data">
                    @csrf
                   <div class="col-sm-12">
                      <div class="row">
                     ...
                     <div class="form-group col-sm-5">
                      ...
                      <div class="form-group">
                        ...
                        <input id='report_datetime' type="text" class="form-control" placeholder="Enter Date..." name="report_datetime">
                     </div>

                     <div class="form-group">
                        <label>Complete Date</label>
                        <input id='complete_date' type="text" class="form-control" placeholder="Enter Date..." name="complete_date">
                     </div>

                     <div class="form-group">
                        <label>Customer Name</label>
                        <input type="hidden" name="contact_id" id="contact_id"/>
                        <input type="text" class="form-control" placeholder="Customer Name" name="contact_name" id="contact_name">
                     </div>
                     ...
                     <div class="form-check">
                        ...
                        <input type="radio" name="add_to_cal" value="1" checked="checked"> Yes</label>
                        <label class="radio-inline"><input type="radio" name="add_to_cal" value="0" > No</label>
                     ...
                     <div class="form-check">
                        ...
                        <label class="radio-inline">
                        <input type="radio" name="status" value="0" checked="checked" style="accent-color:red;"> <div ></div></label>
                        <label class="radio-inline"><input type="radio" name="status" value="1" style="accent-color:green;"> </label>
                        <label class="radio-inline"><input type="radio" name="status" value="2" style="accent-color:yellow;"> </label>
