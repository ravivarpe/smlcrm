...
<html lang="en">
   ...
   <body class="hold-transition sidebar-mini">
      ...
      <div class="wrapper">
        ...
        <li class="{{ Request::is('enquiries') ? 'active current-page' : '' }}">
          <a href="{{ url('enquiries') }}"><i class="fa fa-envelope-o"></i> <span>Enquiry <small class="label float-right bg1-green">0</small></span></a>
        </li>
        <li class="{{ Request::is('contacts') ? 'active current-page' : '' }}">
          <a href="{{ url('contacts') }}"><i class="fa fa-phone"></i> <span>Contacts</span></a>
        </li>

                <li class="{{ Request::is('materials') ? 'active current-page' : '' }}">
                  ...
                  <li class="treeview active">
                     ...
                     <ul class="treeview-menu">
                        <li class="{{ Request::is('invoice') ? 'active current-page' : '' }}"><a href="{{url('invoice')}}">Invoice</a></li>
                        <li class="{{ Request::is('create-invoice') ? 'active current-page' : '' }}"><a href="{{url('create-invoice')}}">Add Invoice</a></li>
                ...
                <li class="{{ Request::is('tasks') ? 'active current-page' : '' }}">
                    <a href="{{url('tasks')}}">
                 ...
                 <li class="{{ Request::is('team') ? 'active current-page' : '' }}">
                    <a href="{{url('team')}}">
               ...
               <li class="{{ Request::is('calendar') ? 'active current-page' : '' }}">
                 ...
                 <li class="{{ Request::is('jobs') ? 'active current-page' : '' }}">
                    <a href="{{url('jobs')}}">
               ...
               <li class="{{ Request::is('maps') ? 'active current-page' : '' }}">
                    <a href="{{url('maps')}}">
                   ...
                   <li class="treeview active">
                     ...
                     <ul class="treeview-menu">
                      <li class="{{ Request::is('asset') ? 'active current-page' : '' }}"><a href="{{url('asset')}}">List</a></li>
                     <li class="{{ Request::is('create-asset') ? 'active current-page' : '' }}"><a href="{{url('create-asset')}}">Add Asset</a></li>
                     </ul>
                  </li>
                  
               
               
              <li class="{{ Request::is('snagging-lists') ? 'active current-page' : '' }}">
