 ...
 <div class="content-wrapper">
   ...
   <div class="modal fade" id="addtask" tabindex="-1" role="dialog">
    <div class="modal-dialog">
       <div class="modal-content site-vis">
            ...
            <form action="#" method="post" enctype="multipart/form-data" id="addTaskForm">
               ...
               <div class="row">
                <div id="tabs_container">
                    ...
                    <li><a href="#tab0" data-toggle="tab" class="active" aria-selected="true" role="tab">Task</a></li>
                    <li><a href="#tab1" data-toggle="tab" aria-selected="false" role="tab"> Details</a></li>
                    </ul>
