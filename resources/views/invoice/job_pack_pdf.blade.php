    ...
    <table class="table table-hover" style="width: 100%;">
      ...
      <tbody>
        ...
        <tr class="">
          ...
          <td style="width: 36%;"><input type="text" placeholder="Description" class="form-control" name="ugDes[]"></td>
    ...
    <table class="table table-hover" style="width: 100%;">
      ...
      <tbody>
        ...
        <tr class="">
          ...
          <td style="width: 36%;"><input type="text" placeholder="Description" class="form-control" name="ovDes[]"></td>
    ...
    <table class="table table-hover" style="width: 100%;">
      ...
      <tbody>
        ...
        <tr class="">
          ...
          <td style="width: 36%;"><input type="text" placeholder="Description" class="form-control" name="otDes[]"></td>
...
<table class="table table-hover" style="width: 100%;">
  ...
  <tbody class="table-data">
    ...
    <tr class="">
      ...
      <td><input type="text" placeholder="Description" class="form-control" name="acstDes[]"></td>
...
<div class="row"  style="display: table; width: 100%;">
  <label for="inputJobStartDate" class="col-sm-2" >Job Start Date</label>
  <div class="col-sm-2">
    <input type="date" name="job_start_date1" class="form-control" value="{{$jobPack['job_start_date']}}">
  </div>
  <label for="inputJobStartTime" class="col-sm-2">Job Start Time</label>
  <div class="col-sm-2">
...
<div class="row" style="display: table; width: 100%;">
  <label for="inputJobEndDate" class="col-sm-2">Job End Date</label>
  <div class="col-sm-2">
