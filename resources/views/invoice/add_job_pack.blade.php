             ...
             <div class="card lobicard all_btn_card" id="lobicard-custom-control1" data-sortable="true">
                 <div class="card-header all_card_btn">
                     ...
                     <div class="card-title custom_title">
                      <a class="btn btn-add" href="invoicelist.html"><i class="fa fa-list"></i> Job Pack List </a>
                     </div>
                 </div>
                 <div class="card-body">
                <form>
                   <div class="col-sm-12">
                    ...
                    <div class="form-group row mx-0">
                      ...
                      <div class="form-group">
                         ...
                         <textarea class="form-control" rows="3" placeholder="description" name="job_description" ></textarea>
                      </div>

                      <div class="form-group">
                        <label>Job Details</label>
                        <textarea class="form-control" rows="3" placeholder="description" name="job_details" ></textarea>
                     </div>
                     <div class="form-group">
